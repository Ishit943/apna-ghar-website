...
export const Route = createFileRoute("/admin/team-dashboard")({
  head: () => ({
    meta: [
      { title: "Team Member Dashboard | Apna Ghar Consultants" },
      {
        name: "description",
        content: "Manage properties as a team member",
      },
    ],
  }),
...
function TeamDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"properties" | "add-property">("properties");
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">You must be a team member to access this page</p>
  ...
  const userProperties = properties.filter(p => p.addedBy === user.id);
      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-background/85 border-b border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            <div>
              <h1 className="font-serif text-xl font-bold text-primary">Team Member Dashboard</h1>
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === "properties" && (
          <div className="space-y-6">
            <h2 className="font-serif text-2xl font-bold text-primary">My Properties</h2>
